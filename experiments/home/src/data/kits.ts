...
export const KITS: ReadonlyArray<Kit> = [
  ...
  // ФИПИ ОГЭ-2026, Приложение 2, Комплект №3: 9 опытов.
  {
    ...
    experiments: [
      ...
      { id: 'connections',          title: 'Правило напряжений (последоват.)',      resultVerb: 'Проверь правило напряжений при последовательном соединении', fipiTask: '3.8', isFipi: true, done: false },
      { id: 'connections',          title: 'Правило токов (параллельное)',          resultVerb: 'Проверь правило токов при параллельном соединении',     fipiTask: '3.9', isFipi: true, done: false },
    ],
    photo: 'kit-3.svg',

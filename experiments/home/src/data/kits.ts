...
export const KITS: ReadonlyArray<Kit> = [
  ...
  // КИТ-3 — электричество, ready (все 9 опытов реализованы, Фазы A–F закрыты 2026-06-28)
  // ФИПИ ОГЭ-2026, Приложение 2, Комплект №3: 9 опытов — 9/9 DoD-ready.
  {
    num: 3,
    status: 'ready',
    priority: 'medium',
  ...
  // ФИПИ ОГЭ-2026, Приложение 2, Комплект №4: 6 опытов.
  {
    ...
    experiments: [
      // KitExperiment.id должен совпадать со слагом зарегистрированного экрана (?screen=<id>).

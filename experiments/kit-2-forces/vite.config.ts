  ...
  build: {
    ...
    rollupOptions: {
      output: {
        ...
        manualChunks: {
          'screen-spring-stiffness': ['./src/screens/spring-stiffness/SpringStiffnessScreen.ts'],
          'screen-spring-elastic': ['./src/screens/spring-elastic/SpringElasticScreen.ts'],
          'screen-friction': ['./src/screens/friction/FrictionScreen.ts'],
        },

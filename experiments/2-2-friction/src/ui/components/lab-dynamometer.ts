...
<svg viewBox="0 0 ${SVG_WIDTH} ${SVG_HEIGHT}" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Крупная маркировка диапазона СНИЗУ корпуса (как у школьных динамометров) -->
  <g class="brand-top" transform="translate(${BODY_X + BODY_W / 2}, ${BODY_Y + BODY_H - 14})">
  ...
  <g transform="translate(${BODY_X + BODY_W / 2}, ${BODY_Y + 12})">
    <text font-family="var(--font-display, sans-serif)"
          font-size="5.5" font-weight="700"
          fill="rgb(0 0 0 / 0.5)"
          text-anchor="middle"
          letter-spacing="0.15em">ЛАБОСФЕРА</text>
  </g>
...
export class LabDynamometer extends HTMLElement {
  ...
  #updateState(): void {
    // Крупная маркировка диапазона сверху корпуса

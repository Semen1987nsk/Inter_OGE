/**
 * CircuitDragController — drag-and-drop контроллер для электрических цепей.
 *
 * Используется в опытах 3.1–3.3 (MeasurementsExperiment) и 3.4 (IvCurveExperiment).
 * Pointer-events + ghost-оверлей + snap-зоны.
 *
 * Extracted from MeasurementsExperiment.ts (Task 4 DRY refactor).
 */
...
export class CircuitDragController<TKind extends string, TId extends string> {
  #overlay: HTMLElement;

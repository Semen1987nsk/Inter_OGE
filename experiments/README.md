...
```
experiments/
├── kit2/                           # Комплект №2: Механика - Пружины, трение, рычаги
│   ├── experiment-1-spring.html    # Опыт 2-1: Измерение жёсткости пружины
│   ├── experiment-1-spring.js      # Логика опыта 2-1
│   └── experiment-1-spring.css     # Стили опыта 2-1
├── shared/                         # Общие модули
│   ├── physics-engine.js           # Физические расчёты (закон Гука, осцилляции)
│   ├── particle-effects.js         # Система частиц (эффекты)
│   ├── canvas-utils.js             # Утилиты для Canvas
│   └── realistic-renderer.js       # Реалистичный рендеринг оборудования
└── styles/                         # Общие стили
...
Согласно официальной спецификации ФИПИ ОГЭ 2025, проект реализует **7 комплектов оборудования**:

- **Комплект №1** (5 опытов): Плотность и архимедова сила
- **Комплект №2** (6 опытов): Пружины, трение, рычаги ✅ **В разработке**
- **Комплект №3** (9 опытов): Электричество (законы постоянного тока)
- **Комплект №4** (6 опытов): Оптика (линзы и преломление)
- **Комплект №5** (8 опытов): Колебания и движение ⚠️ НЕ используется в 2025
- **Комплект №6** (4 опыта): Рычаги и блоки
- **Комплект №7** (4 опыта): Термодинамика (калориметрия) ⚠️ НЕ используется в 2025

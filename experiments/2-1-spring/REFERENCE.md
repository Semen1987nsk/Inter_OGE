...
День 1 — Контекст:
- [ ] Прочитать ФИПИ-спеку (`.business/Исходники/ФИ-9 ОГЭ 2026_СПЕЦ.pdf`)
      — найти своё задание. См. §29.
...
- **Компоненты:** `C:\dev\Inter_OGE\фото оборудования\` — 17 PNG/JPG
  отдельных предметов (пружины k=50/10, диски, динамометры, цилиндры,
  брусок, штатив).
...
Эталоны:
- `2026-05-06-каталог-главная-страница.md` — спека главной SPA.
- `2026-05-06-drag-matrix-kit-1.md` — матрица drag&drop для опыта 1.1
  (50 комбинаций, инварианты).
- `2026-05-06-blind-spots-testing.md` — анализ слепых зон тестирования
  (10 категорий edge-cases).
- `2026-05-14-наборный-груз-сборочный-верстак.md` — сборочный верстак
  Кит-2.

**Формат:** Markdown с таблицами состояний, ASCII-диаграммами,
риск-реестром, DoD-чеклистом.

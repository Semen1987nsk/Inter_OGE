...
**Итого kit-1: 3 ✅ (1.1, 1.3, 1.4) + 1 ⚠️ (1.2 — только вода) + 1 ❌ (1.5) = 3/5.** 1.4 закрыт 2026-05-24.
...
|---|---|---|---|---|---|
| 1 Гидростатика | 5 | 3 (плотность 1.1, F_А от V 1.3, **F_А от ρ 1.4**) | 1 (архимед 1.2 — только вода) | 1 (1.5) | — |
...
- kit-1: ~~1.3, 1.4 + переключатель жидкости~~ ✅ (1.3 — 2026-05-16, 1.4 — 2026-05-24); осталось 1.5 (независимость F_арх от массы)

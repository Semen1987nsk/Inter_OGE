...
**Итого kit-2: 6 ✅ + 1 ❌ отсутствует (F_упр одной точкой) = 6/7 (если разделять Task A/B/C/D).** Task B закрыт 2026-05-24.
...
| 2 Силы и пружины | 6 | 6 (жёсткость, μ, **работа трения**, F_тр(N), F_тр(пов), Гука-график) | — | 1 (F_упр одной точкой) | 1 (работа упругости) |
...
- kit-2: ~~дореализовать `friction/` Task B (work = F_тр·s)~~ ✅ сделано 2026-05-24;
  осталось добавить «Измерение F_упр» (как mini-режим в spring-stiffness/ или отдельным экраном)

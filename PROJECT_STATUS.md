...
### Количество опытов по ФИПИ:

| Комплект | Опытов | Реализовано | Процент | Статус |
|----------|--------|-------------|---------|--------|
| **№1** Механика (плотность/архимедова) | 5 | 1 | 20% | ⚠️ Частично |
| **№2** Механика (пружины/трение) | 7 | 0 | 0% | 🔴 Нет |
| **№3** Электричество (токи) | 9 | 1 | 11% | ⚠️ Частично |
| **№4** Оптика (линзы) | 6 | 0 | 0% | 🔴 **Неправильно!** |
| **№6** Оптика (преломление) | 6 | 2 | 33% | ⚠️ Частично |
| **№5** НЕ ИСПОЛЬЗУЕТСЯ | - | 1 | - | 🔴 **Лишнее!** |
| **№7** НЕ ИСПОЛЬЗУЕТСЯ | - | 1 | - | 🔴 **Лишнее!** |
| **ИТОГО (используемые)** | **33** | **4** | **12%** | 🔴 |

...
Комплект №2 → 6 опытов (пружины + трение + работа)
...
Комплект №2:       1/6 опытов (17%) ⚠️ В разработке
...
3. **Проект намного больше**, чем казалось: не 7, а **30 опытов** нужно реализовать (в ОГЭ 2025, без комплектов №5 и №7).
